...
void tx_CAN() {
  ...
  //     wheel_motor_can(WheelCan1, rpm[0]);
  //     wheel_motor_can(WheelCan2, rpm[1]);
  //     wheel_motor_can(WheelCan3, rpm[2]);
  //     wheel_motor_can(WheelCan4, rpm[3]);
...
void CTLRE_CAN() {
  ...
  int16_t contact1_int16 = int16_t(contact[0]);
  // int16_t euler_degree1_int16_HIGH = euler_degree1_int16 >> 8;
  // int16_t euler_degree1_int16_LOW = euler_degree1_int16-(euler_degree1_int16_HIGH<<8);

  int16_t contact2_int16 = int16_t(contact[1]);
  // int16_t euler_degree2_int16_HIGH = euler_degree2_int16 >> 8;
  // int16_t euler_degree2_int16_LOW = euler_degree2_int16-(euler_degree2_int16_HIGH<<8);

  int16_t RotEnc_position1_int16 = int16_t(Rotary_Encoder_pos1*100);
  // int16_t euler_degree3_int16_HIGH = euler_degree3_int16 >> 8;
  // int16_t euler_degree3_int16_LOW = euler_degree3_int16-(euler_degree3_int16_HIGH<<8);

  int16_t RotEnc_position2_int16 = int16_t(Rotary_Encoder_pos2*100);
  // int16_t checksum_int16_HIGH = checksum_int16 >> 8;
  // int16_t checksum_int16_LOW = checksum_int16-(checksum_int16_HIGH<<8);

  SensorCan2.Data[0] = byteRead(contact1_int16, 1);
  SensorCan2.Data[1] = byteRead(contact1_int16, 0);
  SensorCan2.Data[2] = byteRead(contact2_int16, 1);
  SensorCan2.Data[3] = byteRead(contact2_int16, 0);
  SensorCan2.Data[4] = byteRead(RotEnc_position1_int16, 1);
  SensorCan2.Data[5] = byteRead(RotEnc_position1_int16, 0);
  SensorCan2.Data[6] = byteRead(RotEnc_position2_int16, 1);
  SensorCan2.Data[7] = byteRead(RotEnc_position2_int16, 0);
